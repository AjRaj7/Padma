...
import { ArrowRight, ArrowLeft, Trash2, Target } from 'lucide-react';
...
const OnboardingFlow: React.FC = () => {
  ...
  const handleFinishSetup = () => {
    ...
    // Always create a "Savings" stream with remaining amount
    const totalAllocated = tempStreams.reduce((sum, stream) => sum + stream.originalAmount, 0);
    const savingsAmount = Math.max(0, parseInt(monthlyIncome) - totalAllocated);
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <Switch
                ...
                id="is-goal"
              />
              <label htmlFor="is-goal" className="text-sm text-foreground flex items-center space-x-2">
